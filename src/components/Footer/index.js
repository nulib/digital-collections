...
class Footer extends Component {
  render() {
    ...
    const libraryLinks = [
      ...
      {
        url:
          'http://www.library.northwestern.edu/about/library-jobs/index.html',
        label: 'Library Jobs'
      },
      {
        url:
        ...
        <div className="contain-970">
          <div className="footer-content">
            ...
            <ul>
              ...
              <li>
                <a href="http://www.northwestern.edu/hr/careers/">Careers</a>
              </li>
              <li>
                <a href="http://www.northwestern.edu/disclaimer.html">
                  Disclaimer
                </a>
              </li>
              <li>
                <a href="http://www.northwestern.edu/emergency/index.html">
                  Campus Emergency Information
                </a>
              </li>
              <li>
                <a href="http://policies.northwestern.edu/">
                  University Policies
                </a>
              </li>
            </ul>

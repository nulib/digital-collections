...
describe("About page", () => {
  ...
  it("displays section: collection highlights along with photo grid to display work", () => {
    ...
    cy.get("@feature-two-col1").find(".feature-box").first().as("feature-box1");
    cy.get("@feature-two-col1").find(".feature-box").eq(1).as("feature-box2");

    cy.get("@feature-two-col2").find(".feature-box").first().as("feature-box3");
    cy.get("@feature-two-col2").find(".feature-box").eq(1).as("feature-box4");

    cy.get("@feature-two-col3").find(".feature-box").first().as("feature-box5");
    cy.get("@feature-two-col3").find(".feature-box").eq(1).as("feature-box6");
